        ...
        self.config = {
            ...
            "enwiki": {
                ...
                "sandboxes": {
                    ...
                    "Project:Tutorial (historical)/Citing sources/sandbox": "general",
                    "Project:Tutorial (historical)/Formatting/sandbox": "general",
                    "Project:Tutorial (historical)/Keep in mind/sandbox": "general",
                    "Project:Tutorial (historical)/Wikipedia links/sandbox": "general",
                    "Project talk:Tutorial (historical)/Citing sources/sandbox": "general",
                    "Project talk:Tutorial (historical)/Formatting/sandbox": "general",
                    "Project talk:Tutorial (historical)/Keep in mind/sandbox": "general",
                    "Project talk:Tutorial (historical)/Wikipedia links/sandbox": "general",
